                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: flex;">
                                            {{-- Sửa --}}
                                            <a href="{{route('ads.edit', $value->id)}}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cập nhật" style="margin-right: 5px"><i class="fadeIn animated bx bx-edit"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
