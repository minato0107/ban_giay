    ...
    <form action="{{route('banner.store')}}" method="POST" role="form">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Nhập tên banner" name="name" onkeyup="ChangeToSlug()">
                    @error('name')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <textarea name="content" id="inputContent" class="form-control" rows="3" ></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
