                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="pagination-box mt-10">
                            ...
                            <li><a class="Previous" href="{{ $blog->previousPageUrl() }}"><i class="fa fa-chevron-left"></i> Previous</a>
                            @endif
                            </li>
                            @for($i=1; $i<$blog->lastPage(); $i++)
                            <li class="active"><a href="{{$blog->url($i)}}">{{$i}}</a></li>
                            @endfor
                            @if ($blog->currentPage() < $blog->lastPage())
                            <li>
                              <a class="Next" href="{{$blog->nextPageUrl()}}"> Next <i class="fa fa-chevron-right"></i></a>
                          </li>
                          @endif
                      </ul>
                  </div>
